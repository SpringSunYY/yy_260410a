...
<!--      </el-form-item>-->
    ...
    <el-table v-loading="loading" :data="remindInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="配置" align="center" prop="reminderId" v-if="columns[1].visible"
                       :show-overflow-tooltip="true"/>
      <el-table-column label="居民" align="center" prop="residentName" v-if="columns[2].visible"
                       :show-overflow-tooltip="true"/>
      ...
      <el-table-column label="提醒标题" align="center" prop="reminderTitle" v-if="columns[4].visible"
                       :show-overflow-tooltip="true"/>
      <el-table-column label="提醒内容" align="center" prop="reminderContent" v-if="columns[5].visible"
                       :show-overflow-tooltip="true"/>
      <el-table-column label="提醒时间" align="center" prop="remindTime" width="180" v-if="columns[6].visible"
                       :show-overflow-tooltip="true">
        <template #default="scope">
      ...
      <el-table-column label="已读时间" align="center" prop="readTime" width="180" v-if="columns[8].visible"
                       :show-overflow-tooltip="true">
        <template #default="scope">
          <span>{{ parseTime(scope.row.readTime, '{y}-{m}-{d} {h}:{i}:{s}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="所属用户" align="center" prop="userName" v-if="columns[9].visible"
                       :show-overflow-tooltip="true"/>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)"
                     v-hasPermi="['manage:remindInfo:edit']">修改
          </el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)"
                     v-hasPermi="['manage:remindInfo:remove']">删除
          </el-button>
        </template>
      </el-table-column>
    </el-table>
