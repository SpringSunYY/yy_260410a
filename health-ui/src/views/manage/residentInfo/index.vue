<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="residentInfoList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
              <el-table-column label="编号" align="center" prop="id" v-if="columns[0].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="居民名称" align="center" prop="residentName" v-if="columns[1].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="性别" align="center" prop="gender" v-if="columns[2].visible">
                <template #default="scope">
                      <dict-tag :options="sys_user_sex" :value="scope.row.gender"/>
                </template>
              </el-table-column>
                <el-table-column label="出生日期" align="center" prop="birthDateTime" width="180" v-if="columns[3].visible" :show-overflow-tooltip="true">
                <template #default="scope">
                  <span>{{ parseTime(scope.row.birthDateTime, '{y}-{m}-{d} {h}:{i}:{s}') }}</span>
                </template>
              </el-table-column>
                <el-table-column label="身份证号" align="center" prop="idCard" v-if="columns[4].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="联系电话" align="center" prop="contactPhone" v-if="columns[5].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="居住地址" align="center" prop="address" v-if="columns[6].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="紧急联系人" align="center" prop="emergencyContact" v-if="columns[7].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="紧急联系电话" align="center" prop="emergencyPhone" v-if="columns[8].visible" :show-overflow-tooltip="true"/>
                ...
                <el-table-column label="所属用户" align="center" prop="userId" v-if="columns[10].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="创建人" align="center" prop="createBy" v-if="columns[11].visible" :show-overflow-tooltip="true"/>
                ...
                <el-table-column label="更新人" align="center" prop="updateBy" v-if="columns[13].visible" :show-overflow-tooltip="true"/>
        ...
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['manage:residentInfo:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['manage:residentInfo:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="residentInfoRef" :model="form" :rules="rules" label-width="80px">
                        <el-form-item label="居民名称" prop="residentName">
...
<script setup name="ResidentInfo">
  import { listResidentInfo, getResidentInfo, delResidentInfo, addResidentInfo, updateResidentInfo } from "@/api/manage/residentInfo";
