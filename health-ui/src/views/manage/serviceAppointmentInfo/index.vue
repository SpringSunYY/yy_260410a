  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="serviceAppointmentInfoList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
              <el-table-column label="编号" align="center" prop="id" v-if="columns[0].visible" :show-overflow-tooltip="true"/>
                ...
                <el-table-column label="联系方式" align="center" prop="contactMethod" v-if="columns[3].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="预约标题" align="center" prop="appointmentTitle" v-if="columns[4].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="预约原因" align="center" prop="appointmentReason" v-if="columns[5].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="预约日期" align="center" prop="appointmentTime" width="180" v-if="columns[6].visible" :show-overflow-tooltip="true">
                <template #default="scope">
                ...
                <el-table-column label="预约医生" align="center" prop="appointmentUserId" v-if="columns[9].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="服务时间" align="center" prop="serviceTime" width="180" v-if="columns[10].visible" :show-overflow-tooltip="true">
                <template #default="scope">
        ...
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['manage:serviceAppointmentInfo:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['manage:serviceAppointmentInfo:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="serviceAppointmentInfoRef" :model="form" :rules="rules" label-width="80px">
                        ...
                        <el-form-item label="预约医生" prop="appointmentUserId">
                          <el-input v-model="form.appointmentUserId" placeholder="请输入预约医生" />
                        </el-form-item>
...
<script setup name="ServiceAppointmentInfo">
  import { listServiceAppointmentInfo, getServiceAppointmentInfo, delServiceAppointmentInfo, addServiceAppointmentInfo, updateServiceAppointmentInfo } from "@/api/manage/serviceAppointmentInfo";

  const { proxy } = getCurrentInstance();
      const { health_date_type, healt_service_type, health_appointment_status } = proxy.useDict('health_date_type', 'healt_service_type', 'health_appointment_status');
