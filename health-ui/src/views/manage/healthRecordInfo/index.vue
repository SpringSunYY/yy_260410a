    ...
    <el-table v-loading="loading" :data="healthRecordInfoList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
              <el-table-column label="编号" align="center" prop="id" v-if="columns[0].visible" :show-overflow-tooltip="true"/>
                ...
                <el-table-column label="档案编号" align="center" prop="recordCode" v-if="columns[2].visible" :show-overflow-tooltip="true"/>
                ...
                <el-table-column label="既往病史" align="center" prop="pastHistory" v-if="columns[5].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="家族病史" align="center" prop="familyHistory" v-if="columns[6].visible" :show-overflow-tooltip="true"/>
        ...
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['manage:healthRecordInfo:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['manage:healthRecordInfo:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
<script setup name="HealthRecordInfo">
  import { listHealthRecordInfo, getHealthRecordInfo, delHealthRecordInfo, addHealthRecordInfo, updateHealthRecordInfo } from "@/api/manage/healthRecordInfo";
