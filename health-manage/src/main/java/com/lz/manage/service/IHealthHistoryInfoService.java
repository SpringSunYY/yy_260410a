 ...
 * @date 2026-04-13
 */
public interface IHealthHistoryInfoService extends IService<HealthHistoryInfo>
{
    //region mybatis代码
    /**
     * 查询健康记录
     ...
     * 获取查询条件
     *
     * @param healthHistoryInfoQuery 查询条件对象
     * @return 查询条件
     */
    QueryWrapper<HealthHistoryInfo> getQueryWrapper(HealthHistoryInfoQuery healthHistoryInfoQuery);

    /**
     * 转换vo
     *
     * @param healthHistoryInfoList HealthHistoryInfo集合
